...
<head>
	...
	<!-- Favicon Load -->
	<link rel="shortcut icon" href="<?= base_url($theme_assets); ?>/assets/favicon.ico" type="image/x-icon">

	<!-- Load STyle -->
	<link href="<?= base_url($theme_assets); ?>/assets/css/style.css" rel="stylesheet">
