...
<head>
	...
	<link rel="stylesheet" href="<?= base_url($child_theme_assets); ?>/assets/css/pages/auth.css">
	...
	<div id="auth">
		...
		<div class="row h-100">
			<div class="col-lg-5 col-12">
				<div id="auth-left">
					<div class="auth-logo">
						<a href="<?= site_url(); ?>"><img src="<?= base_url($custom_assets); ?>/img/logo/logo_blue.png" alt="Logo"></a>
					</div>
